...
function AgregarAlDom() {
    ...
    $('#bebidaIngresada').append((`<h3>Ultima bebida ingresada:</h3><p>Bebida: ${bebidaIngresada}</p><p>Cantidad: ${cantidadIngresada}</p>`));
    $("#bebidaIngresada").fadeOut("slow", function() {

        $("#bebidaIngresada").fadeIn(1000);
    });
...
function MostrarTodasBebidas(e) {
    ...
    $("#mostrarTodas").fadeOut("slow", function() {

        $("#mostrarTodas").fadeIn(1000);
    });
